...
waypoint | waypoint create \<name> [x y z]<br/>waypoint delete \<name><br/>waypoint list [page]<br/>waypoint goto \<name><br/>waypoint info \<name> | wp | Used to create and travel to waypoints.
